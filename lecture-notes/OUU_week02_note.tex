...
{\Large\bfseries Week 2 --- Optimization Theory Review: Convexity, LP, and a Probability Warm-up}\\[2pt]
...
% ---------------------------------------------------------------- 7
\beat{7}{Probability review \ {\normalsize\normalfont (if time permits --- continued after duality)}}
\begin{board}
...
{\color{keyink}\small\textbf{next lecture}\quad duality, a full session: every LP comes with a shadow LP --- prices, certificates, and why $\max = \min$.}
