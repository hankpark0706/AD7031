...
\quad {\color{punchink}the scenario index goes \emph{up}:} \ $\xi^s$ is scenario $s$; \ a \emph{subscript} $\xi_j$ is
      component $j$ of a vector (Section 8). two different jobs, two different slots.
\vspace{6pt}
...
\quad $\mathbb{P}(\tilde\xi \ge 1) = p_2 + p_3 = \tfrac34$ \qquad --- the $\tfrac34$ Section 2 reached by conditioning
\vspace{12pt}
...
\end{board}
%% ------------------------------------------------------------------ 9
\beat{9}{The bridge to optimization}
\begin{board}
...
\quad Section 8's linear combinations with $c = x$: \qquad
