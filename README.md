...
| 3 | 9/12 | Linear and quadratic programs; convexity-preserving operations; probability review (start) | [week02](lecture-notes/OUU_week02_note.pdf) | | [George Dantzig, The Accidental Maths Genius (Good Will Hunting in Real Life)](https://www.youtube.com/watch?v=xynFFqcSZDY) | **[HW#1](homework/hw01.pdf) out** (due 9/26) |
| 4 | 9/19 | Probability review (cont.) — Markowitz as running example; duality and conic programming | [week02](lecture-notes/OUU_week02_note.pdf) · [week04](lecture-notes/OUU_week04_note.pdf) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/hankpark0706/AD7031/blob/main/notebooks/week03_markowitz.ipynb) *markowitz* | | |
| 5 | 9/26 | *No class* | | | | |
...
| 10 | 10/31 | Two-stage models 1 — two-stage location–allocation problem (LAP) | | | | |
...
- Week 6 — topic pitch (oral)
- Week 11 — written draft
- Week 16 — presentation and final submission

## Reference

G. Hanasusanto, H. Park, *Optimization Under Uncertainty: Models, Methods, and Guarantees* (draft), 2026.
